    ...
    class s {
      ...
      getStagePromise(e) {
        switch (e) {
          ...
          default:
            throw Object.defineProperty(
              new u.InvariantError(`Invalid render stage: ${e}`),
              "__NEXT_ERROR_CODE",
...
${t}`
      ...
      return (
        e.abort(
          Object.defineProperty(
            new y.BailoutToCSRError("Render in Browser"),
            "__NEXT_ERROR_CODE",
      ...
      if (!K.test(t)) {
        ...
        if (q.test(t)) {
          ...
          let i =
            ...
            (a = t),
            ((u = Object.defineProperty(Error(o), "__NEXT_ERROR_CODE", {
              value: "E394",
              enumerable: !1,
              configurable: !0,
            })).stack = u.name + ": " + o + a),
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`));
    ...
    function Z(e, t, r, n) {
      if (n.syncDynamicErrorWithStack)
        throw (
          (J(e, n.syncDynamicErrorWithStack), new s.StaticGenBailoutError())
        );
      if (0 !== t) {
